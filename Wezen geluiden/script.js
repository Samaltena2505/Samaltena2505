(async () => {
    ...
    const sounds = {
        "Fanta": new Audio("my_sounds/Fanta.mp3"),
        "CocaCola": new Audio("my_sounds/CocaCola.mp3"),
        "Sprite": new Audio("my_sounds/Sprite.mp3")
    };

    const images = {
        "Fanta": "my_images/Fanta.png",
        "CocaCola": "my_images/CocaCola.png",
        "Sprite": "my_images/Sprite.png",
